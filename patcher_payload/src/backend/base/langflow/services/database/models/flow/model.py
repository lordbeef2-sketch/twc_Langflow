...
from langflow.services.database.models.flow_share.model import FlowAccessLevel

if TYPE_CHECKING:
    from langflow.services.database.models.folder.model import Folder
    from langflow.services.database.models.flow_share.model import FlowShare
