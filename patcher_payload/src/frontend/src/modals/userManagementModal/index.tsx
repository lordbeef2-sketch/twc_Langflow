...
export default function UserManagementModal({
  ...
  const [canViewAllFlows, setCanViewAllFlows] = useState(
    data?.can_view_all_flows ?? false,
  );
  ...
  useEffect(() => {
    if (open) {
      if (!data) {
        ...
        setCanViewAllFlows(data.can_view_all_flows ?? false);
        ...
        handleInput({
          target: {
            name: "can_view_all_flows",
            value: data.can_view_all_flows ?? false,
          },
        });
      }
    }
        ...
        >
          <div className="grid gap-5">
            ...
            <div className="flex gap-8">
              ...
              {userData?.is_superuser && (
                <Form.Field name="can_view_all_flows">
                  <div>
                    <Form.Label className="data-[invalid]:label-invalid mr-3">
                      All Workflows
                    </Form.Label>
                    <Form.Control asChild>
                      <Checkbox
                        checked={canViewAllFlows}
                        value={canViewAllFlows}
                        id="can_view_all_flows"
                        className="relative top-0.5"
                        onCheckedChange={(value) => {
                          handleInput({
                            target: {
