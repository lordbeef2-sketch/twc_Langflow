...
/**
 * Header text for user management page
 * @constant
 *
 */
export const ADMIN_HEADER_TITLE = "User Management";

/**
 * Header description for user management page
 * @constant
 *
 */
...
// Auto-login is intentionally disabled for security.
...
export const BUG_REPORT_URL = DOCS_URL;
