                      ...
                      >
                        <div className="relative flex w-full">
                          <SidebarMenuButton
                            size="md"
                            onDragOver={
                              item.readonly ? undefined : (e) => dragOver(e, item.id!)
                            }
                            onDragEnter={
                              item.readonly ? undefined : (e) => dragEnter(e, item.id!)
                            }
                            onDragLeave={item.readonly ? undefined : dragLeave}
                            onDrop={
                              item.readonly ? undefined : (e) => onDrop(e, item.id!)
                            }
                            key={item.id}
