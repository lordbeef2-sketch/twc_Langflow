...
import { isFlowOwner, isFlowReadOnly } from "@/utils/flowAccess";
...
const DropdownComponent = ({
  ...
  const canDeleteFlow = isFlowOwner(flowData);
  const readOnlyFlow = isFlowReadOnly(flowData);
  ...
  return (
    <>
      ...
      >
        ...
        />
        {readOnlyFlow ? "View details" : "Edit details"}
      </DropdownMenuItem>
      <DropdownMenuItem
        onClick={(e) => {
          e.stopPropagation();
