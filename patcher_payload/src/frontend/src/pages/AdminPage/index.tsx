...
export default function AdminPage() {
  ...
  function handleAllWorkflowsVisibilityEdit(check, userId, user) {
    const userEdit = cloneDeep(user);
    userEdit.can_view_all_flows = !check;
        ...
        mutateUpdateUser(
          {
            ...
            user: {
              ...
              can_view_all_flows: user.can_view_all_flows,
            },
          },
          {
            onSuccess: () => {
                        ...
                        <TableRow key={user.id}>
                          ...
                          <TableCell className="relative left-1 truncate py-2 text-align-last-left">
                            <ConfirmationModal
                              ...
                              index={index}
                              onConfirm={(index, user) => {
                                handleAllWorkflowsVisibilityEdit(
                            ...
                            >
                              ...
                              <ConfirmationModal.Trigger>
                                <div className="flex w-fit">
                                  <CheckBoxDiv
                                    checked={user.can_view_all_flows}
                                  />
                                </div>
                              </ConfirmationModal.Trigger>
                            </ConfirmationModal>
