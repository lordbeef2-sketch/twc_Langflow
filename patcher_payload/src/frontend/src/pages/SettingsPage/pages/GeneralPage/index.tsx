...
import AuthSecuritySettingsCard from "./components/AuthSecuritySettingsCard";
...
export const GeneralPage = () => {
  ...
  const { data: configData } = useGetConfig({ enabled: !!userData });
  ...
  return (
    <div className="flex h-full w-full flex-col gap-6 overflow-x-hidden">
      ...
      <div className="flex w-full flex-col gap-6">
        ...
        {isAdmin && configData && isFullConfig(configData) && (
          <AuthSecuritySettingsCard config={configData} />
        )}
      </div>
