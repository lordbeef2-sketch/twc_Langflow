...
class Settings(
    ...
    twc_preset_servers: list[Any] | dict[str, Any] | str | None = Field(default=None, validation_alias=AliasChoices("TWC_PRESET_SERVERS", "LANGFLOW_TWC_PRESET_SERVERS"))
    twc_auth_client_id: str | None = Field(default=None, validation_alias=AliasChoices("TWC_AUTH_CLIENT_ID", "LANGFLOW_TWC_AUTH_CLIENT_ID", "TWC_AUTHENTICATION_CLIENT_ID", "LANGFLOW_TWC_AUTHENTICATION_CLIENT_ID", "TWC_AUTHENTICATION_CLIENT_IDS", "LANGFLOW_TWC_AUTHENTICATION_CLIENT_IDS"))
    twc_auth_client_secret: SecretStr | None = Field(default=None, validation_alias=AliasChoices("TWC_AUTH_CLIENT_SECRET", "LANGFLOW_TWC_AUTH_CLIENT_SECRET", "TWC_AUTHENTICATION_CLIENT_SECRET", "LANGFLOW_TWC_AUTHENTICATION_CLIENT_SECRET"))
    twc_auth_callback_path: str = Field(default="/api/auth/callback", validation_alias=AliasChoices("TWC_AUTH_CALLBACK_PATH", "LANGFLOW_TWC_AUTH_CALLBACK_PATH"))
    twc_auth_scope: str | None = Field(default="openid", validation_alias=AliasChoices("TWC_AUTH_SCOPE", "LANGFLOW_TWC_AUTH_SCOPE"))
    twc_auto_login: bool = Field(default=False, validation_alias=AliasChoices("TWC_AUTO_LOGIN", "LANGFLOW_TWC_AUTO_LOGIN"))
    twc_auth_server_overrides: dict[str, Any] | str | None = Field(default=None, validation_alias=AliasChoices("TWC_AUTH_SERVER_OVERRIDES", "LANGFLOW_TWC_AUTH_SERVER_OVERRIDES"))
    twc_saml_authorize_url: str | None = Field(default=None, validation_alias=AliasChoices("TWC_SAML_AUTHORIZE_URL", "LANGFLOW_TWC_SAML_AUTHORIZE_URL"))
    twc_saml_token_url: str | None = Field(default=None, validation_alias=AliasChoices("TWC_SAML_TOKEN_URL", "LANGFLOW_TWC_SAML_TOKEN_URL"))
    twc_saml_login_path: str = Field(default="/authentication/authorize", validation_alias=AliasChoices("TWC_SAML_LOGIN_PATH", "LANGFLOW_TWC_SAML_LOGIN_PATH"))
    twc_saml_login_port: int = Field(default=8443, validation_alias=AliasChoices("TWC_SAML_LOGIN_PORT", "LANGFLOW_TWC_SAML_LOGIN_PORT"))
    twc_saml_token_path: str = Field(default="/authentication/api/token", validation_alias=AliasChoices("TWC_SAML_TOKEN_PATH", "LANGFLOW_TWC_SAML_TOKEN_PATH"))
    twc_saml_return_url_parameter: str = Field(default="redirect_uri", validation_alias=AliasChoices("TWC_SAML_RETURN_URL_PARAMETER", "LANGFLOW_TWC_SAML_RETURN_URL_PARAMETER"))
