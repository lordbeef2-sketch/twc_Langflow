...
class Settings(BaseSettings):
    ...
    https_hsts_enabled: bool = False
    """If True, send Strict-Transport-Security headers on HTTPS responses."""
    https_hsts_max_age: int = 31536000
    """HSTS max-age value in seconds."""
    https_hsts_include_subdomains: bool = False
    """If True, include `includeSubDomains` in HSTS header."""
    https_hsts_preload: bool = False
    """If True, include `preload` in HSTS header."""
